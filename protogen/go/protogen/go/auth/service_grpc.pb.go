...
func (c *authServiceClient) Logout(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BooleanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BooleanResponse)
...
func (UnimplementedAuthServiceServer) Logout(context.Context, *emptypb.Empty) (*BooleanResponse, error) {
